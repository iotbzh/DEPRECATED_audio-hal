...
# WARNING: SHOULD rm -rf build/*; cmake .. for option to be taken in account
# ----------------------------------------------------------------------------
#set(COMPILE_OPTIONS
#-Wall
#-Wextra
...
-DCONTROL_SUPPORT_LUA=1
-DCONTROL_PLUGIN_PATH="${CMAKE_BINARY_DIR}:${CMAKE_INSTALL_PREFIX}/${PROJECT_NAME}/lib/audio-plugins:/usr/lib/afb/audio-plugins"
...
set(CLOSING_MESSAGE "Debug from afb-daemon --port=1234 ${MONITORING_ALIAS} --workdir=. --roothttp=../htdocs --ldpaths=/dev/null \
    --binding=~/opt/afb-aaaa/lib/afb-alsa-lowlevel.so --binding=./hal-binding/afb-audio-hal.so --token=''")
